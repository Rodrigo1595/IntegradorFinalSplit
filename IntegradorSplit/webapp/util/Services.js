sap.ui.define([
    ...
    return{
     ...
     getoData: async function() {
       ...
       getCategoriabyID: async function(id) {
          const oRequest = this.getRequest({
              endPoint:Constants.ids.Northwind,
              method:"GET",
              entity: "/V3/Northwind/Northwind.svc/Products("+id+")/Category",
          });
          return this.promisizer(oRequest);
      },
        getProveedorbyID: async function(id) {
            const oRequest = this.getRequest({
              endPoint:Constants.ids.Northwind,
              method:"GET",
              entity: "/V3/Northwind/Northwind.svc/Products("+id+")/Supplier",
          });
          return this.promisizer(oRequest);
      },
     ...
     /**
            ...
            */
            ...
            getBaseURL: function (sEndPoint) {
                return jQuery.sap.getModulePath("IntegradorSplit.IntegradorSplit") + "/";
            },
